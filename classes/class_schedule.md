...
- Speed dating with classmates
- Brainstorm problems and personas
- Learn Fermi estimation for market sizing
...
### Weeks 1-2: Explore
*Shopping period — students may still be joining/leaving*

- **c1w1** (Jan 22): Course intro, instructor intros, speed dating, problems brainstorm
- **c2w2** (Jan 27): Repeat intros for new students, speed dating, personas brainstorm
- **c3w2** (Jan 29): HW review, Fermi estimation for audience sizing
